...
[NOTE]
====
link:https://docs.openshift.com/container-platform/latest/applications/application-health.html[Exec probes] need to be avoided at all cost because of the resource overhead the require. Exec probes cannot be used on RT containers.
====
